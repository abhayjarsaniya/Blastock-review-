          ...
          <ul class="treeview-menu">
            @if (is_catalog_enabled())
              @can('index', \App\Models\Inventory::class)
                <li class="{{ Request::is('admin/stock/inventory*') && !Request::is('admin/stock/inventory/digital') ? 'active' : '' }}">
                  <a href="{{ url('admin/stock/inventory') }}">
                    <i class="fa fa-angle-double-right"></i> {{ trans('nav.physical_products') }}
                  </a>
                </li>

                <li class="{{ Request::is('admin/stock/inventory/digital') ? 'active' : '' }}">
                  <a href="{{ route('admin.stock.inventory.index', ['digital' => 'digital']) }}">
            ...
            @if (!is_catalog_enabled() && Auth::user()->isFromMerchant())
              @can('index', \App\Models\Product::class)
                <li class="{{ Request::is('admin/stock/product*') ? 'active' : '' }}">
                  <a href="{{ url('admin/stock/product') }}">
                    <i class="fa fa-angle-double-right"></i> {{ trans('nav.products') }}
                  </a>
                </li>
              @endcan
